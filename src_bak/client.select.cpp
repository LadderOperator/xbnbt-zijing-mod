...
bool CClient :: Update( )
{
	...
	case CS_MAKERESPONSE:
	{
		...
		inet_ntop( AF_INET6, &rqst.sin.sin6_addr, strIP6, INET6_ADDRSTRLEN );
		...
		UTIL_AccessLogPrint( strIP.c_str( ), rqst.user.strLogin, strRequest, atoi( rsp.strCode.substr( 0, 3 ).c_str( ) ), (int)rsp.strContent.size( ) );
